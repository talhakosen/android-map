...
public class MapObject {
     ...
     * @param population
     */
    public MapObject(String name, String capital, List<String> altSpellings, String relevance, String region, String subregion, Translations translations, Integer population, List<Double> latlng, String demonym, Double area, Double gini, List<String> timezones, List<String> borders, String nativeName, List<String> callingCodes, List<String> topLevelDomain, String alpha2Code, String alpha3Code, List<String> currencies, List<String> languages) {
        this.name = name;
